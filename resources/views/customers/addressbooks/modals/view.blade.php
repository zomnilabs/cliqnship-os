    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content mcontent">
            ...
            <div class="modal-header text-center">
                <h4 class="modal-title" id="gridSystemModalLabel">Address Book</h4>
            </div>
            <form method="PUT" id="viewForm" >
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group{{ $errors->has('identifier') ? ' has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" name="identifier" id="identifier" value="" required/>
                    ...
                    <input type="hidden" id="addressbookId" name="user_id" value="0"/>
                </div>
