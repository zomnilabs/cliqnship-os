    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content mcontent">
            ...
            <div class="modal-header text-center">
                <h4 class="modal-title" id="gridSystemModalLabel">Create your primary address first</h4>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group{{ $errors->has('type') ? ' has-error' : '' }}">
                                ...
                                <select name="type" readonly="true" class="form-control" id="type">
                                    <option value="booking">Booking</option>
                                    <option value="shipmemt" disabled>Shipment</option>
                                </select>
                                @if ($errors->has('type'))
                                    <span class="help-block">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class0.="form-group{{ $errors->has('first_name') ? ' has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" name="first_name" id="first_name" value="{{ Auth::user()->profile->first_name }}" required/>
                        ...
                        <div class="col-md-4">
                            <div class="form-group{{ $errors->has('last_name') ? ' has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" name="last_name" id="last_name" value="{{ Auth::user()->profile->last_name }}" required/>
