<div class="modal fade" id="viewUserModal" role="dialog" aria-labelledby="myLargeModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content mcontent">
            ...
            <div class="modal-header text-center">
                <h4 class="modal-title" id="modalTitle">Create Users</h4>
            </div>
            <form id="viewForm">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success" id="formSubmit" onclick="storeData.call(this)"><i class="fa fa-floppy-o"></i> Update Users</button>
                </div>
            </form>
        </div>
    </div>
